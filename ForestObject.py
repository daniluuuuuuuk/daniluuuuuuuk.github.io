"""Классы используются в фильтре для поиска и приближения к объекту
Загружают данные:
    - при инициализации фильтра название лесхоза - из базы данных
    - лесничества лесхоза - из базы данных
    - кварталы лесничества со слоя выделов (при изменении лесхоза)
    - выдела, входящие в квартал - со слоя выделов (при изменении квартала)
рефакторинг
"""
