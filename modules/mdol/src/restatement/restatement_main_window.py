...
class MainWindow(QtWidgets.QMainWindow, uic.loadUiType(BasicDir().get_basic_dir("ui/restatement.ui"))[0]):
    def __init__(self, parent=None):
        ...
        self.action_2.triggered.connect(lambda: settings_caliper.Settings_caliper().exec())
        ...
        self.tableWidget.verticalHeader().setDefaultSectionSize(30)  # Стандартный высота столбцов
        ...
        for i in Settings(group='Diameters', key='dmrs').read_setting():
            ...
            self.tableWidget.setItem(self.tableWidget.rowCount() - 1, 0, QtWidgets.QTableWidgetItem(i))
