...
class MainWindow(QtWidgets.QMainWindow, uic.loadUiType(BasicDir().get_basic_dir("gui/area_property.ui"))[0]):
    ...
    def get_gplho(self):
        ...
        orgs = Organization.select(Organization.id_organization, Organization.name_organization)\
