...
class Data(QtCore.QThread):
    ...
    def __init__(self, **args):
        ...
        self.data_mapping = {
            ...
            "dmrs": {
                '8': '5', '12': '6', '16': '7', '20': '8', '24': '9', '28': '10',  # Столбец A
                '32': '11', '36': '12', '40': '13', '44': '14', '48': '15', '52': '16',
                '56': '17', '60': '18', '64': '19', '68': '20', '72': '21', '76': '22',
                '80': '23', '84': '24', '88': '25', '92': '26', '96': '27', '100': '28',
                '104': '29', '108': '30', '112': '31', '116': '32', '120': '33', '124': '34'
            },
            "alp": ['B', 'C', 'E', 'F', 'G', 'I', 'J', 'K', 'M', 'N', 'O', 'Q', 'R', 'S', 'U',
                    'W', 'X', 'Z', 'AA', 'AB', 'AD', 'AE', 'AF', 'AH', 'AI', 'AJ', 'AL', 'AM', 'AN', 'AP'
                    ]
        }
        ...
        for column in range(columns):
            if self.table.item(0, column):  # Нахожу породу
                ...
                for row in range(rows):
                    num_ind = self.table.item(row, column)
                    num_fuel = self.table.item(row, column+1)
                    num_deadwood = self.table.item(row, column+2)
                    if 1 < row < rows-2:
