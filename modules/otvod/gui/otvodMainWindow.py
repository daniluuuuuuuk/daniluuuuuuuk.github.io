...
# Form implementation generated from reading ui file 'C:\Users\NLK\AppData\Roaming\QGIS\QGIS3\profiles\default\python\plugins\QgsLes\modules\otvod\ui\otvodMainWindow.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.buildLesoseka_Button.setGeometry(QtCore.QRect(440, 10, 21, 21))
        ...
        self.generateReport_Button.setGeometry(QtCore.QRect(560, 10, 21, 21))
        ...
        self.sliderLabel.setGeometry(QtCore.QRect(785, 390, 24, 20))
        ...
        self.azimuthTool_pushButton.setGeometry(QtCore.QRect(620, 10, 21, 21))
        ...
        self.outputLabel.setGeometry(QtCore.QRect(440, 394, 171, 16))
        ...
        self.saveLesoseka_Button.setGeometry(QtCore.QRect(500, 10, 21, 21))
        ...
        self.deleteLesoseka_Button.setGeometry(QtCore.QRect(530, 10, 21, 21))
        ...
        self.rotate_left.setGeometry(QtCore.QRect(734, 10, 20, 21))
        self.rotate_left.setObjectName("rotate_left")
        self.rotate_right = QtWidgets.QPushButton(self.centralwidget)
        self.rotate_right.setGeometry(QtCore.QRect(787, 10, 21, 21))
        self.rotate_right.setObjectName("rotate_right")
        self.rotate_inclination = QtWidgets.QLineEdit(self.centralwidget)
        self.rotate_inclination.setGeometry(QtCore.QRect(755, 10, 31, 20))
        self.rotate_inclination.setAlignment(QtCore.Qt.AlignCenter)
        self.rotate_inclination.setObjectName("rotate_inclination")
        ...
        self.peekVydelFromMap_pushButton.setGeometry(QtCore.QRect(590, 10, 21, 21))
        ...
        self.lesoseka_from_map_button.setGeometry(QtCore.QRect(650, 10, 21, 21))
        ...
        self.editAttributes_button.setGeometry(QtCore.QRect(470, 10, 21, 21))
        ...
        self.importCoordinates.setGeometry(QtCore.QRect(710, 10, 21, 21))
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(30, 390, 296, 21))
        self.horizontalLayoutWidget_2.setObjectName("horizontalLayoutWidget_2")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget_2)
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.coord_radio_button = QtWidgets.QRadioButton(self.horizontalLayoutWidget_2)
        self.coord_radio_button.setObjectName("coord_radio_button")
        self.horizontalLayout.addWidget(self.coord_radio_button)
        self.azimuth_radio_button = QtWidgets.QRadioButton(self.horizontalLayoutWidget_2)
        self.azimuth_radio_button.setObjectName("azimuth_radio_button")
        self.horizontalLayout.addWidget(self.azimuth_radio_button)
        self.rumb_radio_button = QtWidgets.QRadioButton(self.horizontalLayoutWidget_2)
        self.rumb_radio_button.setObjectName("rumb_radio_button")
        self.horizontalLayout.addWidget(self.rumb_radio_button)
        self.angle_radio_button = QtWidgets.QRadioButton(self.horizontalLayoutWidget_2)
        self.angle_radio_button.setObjectName("angle_radio_button")
        self.horizontalLayout.addWidget(self.angle_radio_button)
        self.lesoseka_from_map_points_button = QtWidgets.QPushButton(self.centralwidget)
        self.lesoseka_from_map_points_button.setGeometry(QtCore.QRect(680, 10, 21, 21))
        ...
        self.inclinationSlider.setGeometry(QtCore.QRect(700, 390, 81, 22))
        ...
        self.inclinationSlider.setTracking(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.rotate_left.setText(_translate("MainWindow", "<"))
        self.rotate_right.setText(_translate("MainWindow", ">"))
        self.rotate_inclination.setText(_translate("MainWindow", "0"))
        ...
        self.coord_radio_button.setText(_translate("MainWindow", "Координаты"))
        self.azimuth_radio_button.setText(_translate("MainWindow", "Азимуты"))
        self.rumb_radio_button.setText(_translate("MainWindow", "Румбы"))
        self.angle_radio_button.setText(_translate("MainWindow", "Вн. углы"))
