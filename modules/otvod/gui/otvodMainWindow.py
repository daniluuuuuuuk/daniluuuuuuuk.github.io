...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gpsTablet_pushButton = QtWidgets.QPushButton(self.frame_5)
        self.gpsTablet_pushButton.setMinimumSize(QtCore.QSize(25, 25))
        self.gpsTablet_pushButton.setMaximumSize(QtCore.QSize(25, 25))
        self.gpsTablet_pushButton.setText("")
        self.gpsTablet_pushButton.setObjectName("gpsTablet_pushButton")
        self.horizontalLayout_7.addWidget(self.gpsTablet_pushButton)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.movePoint_button.setToolTip(_translate("MainWindow", "Перемещение точки"))
        self.manageLayers_button.setToolTip(_translate("MainWindow", "Настроить видимость слоев (Ctrl+L)"))
        self.gpsTablet_pushButton.setToolTip(_translate("MainWindow", "Загрузить точки со слоя"))
