...
# Form implementation generated from reading ui file 'C:\Users\pc\AppData\Roaming\QGIS\QGIS3\profiles\default\python\plugins\trial_area\modules\otvod\ui\lesosekaInfo.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(322, 407)
        self.buttonBox = QtWidgets.QDialogButtonBox(Dialog)
        self.buttonBox.setGeometry(QtCore.QRect(0, 370, 301, 32))
        ...
        self.label_6.setGeometry(QtCore.QRect(10, 290, 91, 16))
        self.label_6.setObjectName("label_6")
        self.fio = QtWidgets.QLineEdit(Dialog)
        self.fio.setGeometry(QtCore.QRect(110, 190, 191, 20))
        self.fio.setObjectName("fio")
        self.info = QtWidgets.QTextEdit(Dialog)
        self.info.setGeometry(QtCore.QRect(110, 290, 191, 71))
        ...
        self.date.setGeometry(QtCore.QRect(110, 220, 191, 22))
        ...
        self.gplhoLabel.setGeometry(QtCore.QRect(11, 14, 47, 13))
        self.gplhoLabel.setObjectName("gplhoLabel")
        self.label_11 = QtWidgets.QLabel(Dialog)
        self.label_11.setGeometry(QtCore.QRect(10, 254, 47, 13))
        self.label_11.setObjectName("label_11")
        self.restatement_comboBox = QtWidgets.QComboBox(Dialog)
        self.restatement_comboBox.setGeometry(QtCore.QRect(110, 255, 191, 22))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.gplhoLabel.setText(_translate("Dialog", "ГПЛХО"))
