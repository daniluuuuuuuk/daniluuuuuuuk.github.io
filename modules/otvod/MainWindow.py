...
class MainWindow(QMainWindow, otvodMainWindow):
    ...
    def initHotKeys(self):
        ...
        self.loadDataFromFile.activated.connect(lambda: self.controller.loadDataFromFile())

        self.saveDataToFile = QShortcut(self)
        self.saveDataToFile.setKey(QKeySequence('Ctrl+S'))
        self.saveDataToFile.activated.connect(lambda: self.controller.saveDataToFile())
        ...
        self.peekFromMap.activated.connect(lambda: self.peekFromMap_PushButton.click())

        self.manageLayers = QShortcut(self)
        self.manageLayers.setKey(QKeySequence('Ctrl+L'))
        self.manageLayers.activated.connect(lambda: self.manageLayers_button.click())

        self.azimuthTool = QShortcut(self)
        self.azimuthTool.setKey(QKeySequence('Ctrl+A'))
        self.azimuthTool.activated.connect(lambda: self.azimuthTool_pushButton.click())    

        self.fromMap = QShortcut(self)
        self.fromMap.setKey(QKeySequence('Ctrl+W'))
        self.fromMap.activated.connect(lambda: self.lesoseka_from_map_button.click())

        self.fromMapPoints = QShortcut(self)
        self.fromMapPoints.setKey(QKeySequence('Ctrl+E'))
        self.fromMapPoints.activated.connect(lambda: self.lesoseka_from_map_points_button.click())

        self.peekVydelFromMap = QShortcut(self)
        self.peekVydelFromMap.setKey(QKeySequence('Ctrl+D'))
        self.peekVydelFromMap.activated.connect(lambda: self.peekVydelFromMap_pushButton.click())        

        self.buildLesoseka = QShortcut(self)
        self.buildLesoseka.setKey(QKeySequence('Ctrl+B'))
        self.buildLesoseka.activated.connect(lambda: self.buildLesoseka_Button.click())
        ...
        self.azimuth.activated.connect(lambda: self.azimuth_radio_button.click())
        ...
        self.leftAngle.activated.connect(lambda: self.left_angle_radio_button.click())

        self.rightAngle = QShortcut(self)
        self.rightAngle.setKey(QKeySequence('Ctrl+5'))
        self.rightAngle.activated.connect(lambda: self.right_angle_radio_button.click())
        ...
        self.incrementInclinationOne.activated.connect(partial(self.incrementInclination, 1))

        self.decrementInclinationOne = QShortcut(self)
        self.decrementInclinationOne.setKey(QKeySequence('Ctrl+Down'))
        self.decrementInclinationOne.activated.connect(partial(self.decrementInclination, 1))

        self.incrementInclinationMax = QShortcut(self)
        self.incrementInclinationMax.setKey(QKeySequence('Ctrl+Shift+Up'))
        self.incrementInclinationMax.activated.connect(partial(self.incrementInclination, 10))

        self.decrementInclinationMax = QShortcut(self)
        self.decrementInclinationMax.setKey(QKeySequence('Ctrl+Shift+Down'))
        self.decrementInclinationMax.activated.connect(partial(self.decrementInclination, 10))
